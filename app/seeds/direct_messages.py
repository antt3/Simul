...
def seed_direct_messages():
    ...
    to_ref_1_2 = Direct_message(
        message='First Message', edited=False, created_at='2022-07-20 03:1:30.473031', user_id=1, ref_id=2)
    to_ref_1_3 = Direct_message(
        message='First Message', edited=False, created_at='2022-06-11 04:1:15.473031', user_id=1, ref_id=3)
    to_ref_1_4 = Direct_message(
        message='First Message', edited=False, created_at='2022-08-10 07:1:49.473031', user_id=1, ref_id=4)
    to_ref_2_1 = Direct_message(
        message='Second Message', edited=False, created_at='2022-09-15 18:2:23.473031', user_id=2, ref_id=1)
    to_ref_3_1 = Direct_message(
        message='Second Message', edited=False, created_at='2022-07-23 20:2:54.473031', user_id=3, ref_id=1)
    to_ref_4_1 = Direct_message(
        message='Second Message', edited=False, created_at='2022-08-17 06:2:26.473031', user_id=4, ref_id=1)
