...
def seed_users():
    ...
    marnie = User(
        email='marnie@aa.io', password='password', team='Demo Team', full_name='Marnie Moe Money', nickname='Marnie', bio='I\'m A Fictional Character!', status='true', profile_pic='')
    randy = User(
    ...
    bobbie = User(
        email='bobbie@aa.io', password='password', team='Demo Team', full_name='Bobby Boyle', nickname='', bio='', status='true', profile_pic='')
